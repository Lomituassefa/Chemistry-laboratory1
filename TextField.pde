class TextField {
  ...
  float aiMinBorderSize = 1.5, aiMaxBorderSize = 3; // ai: Activation Indicator
  ...
  color unhoveredFill = blueLight, hoveredFill = blueLight, activeFill = blueLight; // For container fill
  color unhoveredStroke = blueLight, hoveredStroke = backGround, activeStroke = white; // For activation indicator/border & text fill
  color inactiveLabelFill = darkGray, activeLabelFill = 0;
  color valueFill = white;
  color errorFill = purple;
  ...
  void draw () {
    ...
    rect (x, y, w, h, 0, cornerRadius, 0, 25);
